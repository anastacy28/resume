(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage = $("<div class='progress-percentage'></div>", "<div class='progress-percentage2'></div>");
            ...
            // Create text
            var text = $("<div class='progress-text'></div>", "<div class='progress-text2'></div>");
            ...
            $(this).addClass("circular-progress-bar","circular-progress-bar2" );
    ...
    function insertText(scope) {
        ...
        $(".progress-percentage2" ).text(Math.round(global_settings.percent) + "%");
    }
    // create canvas
